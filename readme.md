...
Animated loader (built using stencil and gsap) that can easily be dropped into existing projects. Check out our [DEMO](https://sebastian.proost.science/prokaryote-loader)
